            ...
            @php
                ...
                $products = [
                    ...
                    [
                        ...
                        'desc'=>'Универсальная платежная карта с пониженным минимальным пополнением. Добавляйте в Apple Pay, Google Pay, Samsung Pat, оплачивайте покупки телефоном или часами или обычным методом для онлайн сервисов и магазинов.',
                        'points'=>['ApplePay, GooglePay, SamsungPay','Пополнение от 10$','Для онлайна и для оффлайна'],
