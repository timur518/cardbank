 ...
 * платежей, в той валюте, в которой фактически платил клиент (обычно рубли через СБП).
 * Это разбивка объёма платежей, а не P&L — для прибыли в долларах см. ProfitStatsWidget.
 */
